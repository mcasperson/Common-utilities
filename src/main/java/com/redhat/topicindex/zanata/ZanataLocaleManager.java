...
/**
 * The LocaleManager handles what locales per project should be used to check against
 * the zanata REST interface . All functions lock the list of locales to ensure 
 * thread safety since the locales maybe accessed from multiple concurrent threads.
 */
