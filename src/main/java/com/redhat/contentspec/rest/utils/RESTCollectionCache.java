...
public class RESTCollectionCache
{
	...
	private final HashMap<String, BaseRestCollectionV1<? extends RESTBaseEntityV1<?>>> collections = new HashMap<String, BaseRestCollectionV1<? extends RESTBaseEntityV1<?>>>();
	...
	public <T extends RESTBaseEntityV1<T>> void add(Class<T> clazz, BaseRestCollectionV1<T> value)
	{
		add(clazz, value, null);
	}

	public <T extends RESTBaseEntityV1<T>> void add(Class<T> clazz, BaseRestCollectionV1<T> value, List<String> additionalKeys)
	{
		add(clazz, value, additionalKeys, false);
	}

	public <T extends RESTBaseEntityV1<T>> void add(Class<T> clazz, BaseRestCollectionV1<T> value, List<String> additionalKeys, boolean isRevisions)
	{
	...
	public <T extends RESTBaseEntityV1<T>> boolean containsKey(Class<T> clazz)
	{
		return containsKey(clazz, null);
	}

	public <T extends RESTBaseEntityV1<T>> boolean containsKey(Class<T> clazz, List<String> additionalKeys)
	{
		String key = clazz.getSimpleName();
		if (additionalKeys != null && !additionalKeys.isEmpty())
		{
	...
	public <T extends RESTBaseEntityV1<T>> BaseRestCollectionV1<T> get(Class<T> clazz, List<String> additionalKeys)
	{
		String key = clazz.getSimpleName();
		if (additionalKeys != null && !additionalKeys.isEmpty())
		{
	...
	public <T extends RESTBaseEntityV1<T>> void expire(Class<T> clazz)
	{
		collections.remove(clazz.getSimpleName());
	}

	public <T extends RESTBaseEntityV1<T>> void expire(Class<T> clazz, List<String> additionalKeys)
	{
