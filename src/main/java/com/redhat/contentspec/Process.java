...
public class Process extends Level
{
	 ...
	 * 
	 * @param topicId
	 *            The unique Content Specification Topic ID.
	 * @param branchIds
	 ...
	 * 
	 * @param topicId
	 *            The ID of the topic to search on.
	 * @param topicTargetId
	 *            The Target ID for the topic to search on.
	 * 
	 ...
	 * 
	 * @param specTopics
	 *            A mapping of all the topics in a content specification to their unique ids
	 * @param topicTargets
	 *            The topic targets that already exist in a content specification
	 * @param reader
	 ...
	 * 
	 * @param prevTopic
	 *            The previous topic in the process.
	 * @param topicId
	 *            The Unique ID of the topic.
	 * @param prevTopicTargetID
	 *            The Target ID of the previous topic.
	 * @param topicTargetId
